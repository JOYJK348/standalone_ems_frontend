...
export function ChatWidget() {
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-36 right-4 sm:bottom-24 sm:right-6 z-50 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                    {/* Header */}
