        ...
        <nav className="sticky top-0 z-40 w-full bg-white border-b border-gray-200 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    >
                        <div
                            className={`w-8 h-8 rounded-lg bg-gradient-to-br from-${colorClass}-600 to-${colorClass}-700 flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow`}
                        >
                            <LogoIcon className="h-5 w-5 text-white" />
                        </div>
                        <div className="hidden sm:block">
                            <span
                                className={`text-lg font-bold bg-gradient-to-r from-${colorClass}-600 to-${colorClass}-700 bg-clip-text text-transparent`}
                            >
                                {config.logo.text}
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative" ref={profileMenuRef}>
                            ...
                            >
                                <div
                                    className={`w-7 h-7 rounded-full bg-gradient-to-br from-${colorClass}-600 to-${colorClass}-700 flex items-center justify-center shadow-sm`}
                                >
                                    ...
                                    <div className="py-2">
                                        ...
                                        {config.quickActions.map((action) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <Icon
                                                        className={`h-4 w-4 text-gray-400 group-hover:text-${colorClass}-600`}
                                                    />
