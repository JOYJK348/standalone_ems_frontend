...
export default function TutorMaterialsPage() {
    ...
    const getFileIcon = (fileType: string) => {
        ...
        if (type === "CONTENT")
            return <LayoutList className="h-8 w-8 text-emerald-500" />;
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-slate-100 bg-slate-50/50">
                                            ...
                                            <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hidden md:table-cell">
                                                Type
                                            </th>
                                                        ...
                                                        <td className="px-6 py-5">
                                                            <div className="flex items-center gap-4">
                                                                ...
                                                                <div className="min-w-0">
                                                                    <h4 className="text-sm font-black text-slate-900 leading-tight mb-1 truncate max-w-[200px] sm:max-w-[400px]">
                                                                        {
                                                                            material.material_name
                                                                        }
                                                                    </h4>
                                                            ...
                                                            <div className="flex flex-col items-start gap-1.5">
                                                                ...
                                                                <div className="flex flex-col gap-1 ml-1">
                                                                    {material.course ? (
                                                                        ...
                                                                        <span className="text-[10px] font-bold text-slate-400 italic pl-1">
                                                                            Global
                                                                            Organization
                                                                        </span>
                                                                    )}
