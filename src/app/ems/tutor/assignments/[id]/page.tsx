    ...
    const fetchAssignmentDetails = async () => {
        try {
            ...
            const response = await api.get(
                `/ems/assignments/${assignmentId}/submissions`,
            );
        ...
        <div className="min-h-screen bg-gray-50 pb-24 text-gray-900">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div className="mb-8">
                    <Link
                        href="/ems/tutor/assignments"
                        className="inline-flex items-center text-sm text-gray-500 hover:text-blue-600 mb-4 group"
                    >
                        ...
                        <div className="flex flex-col items-end gap-2">
                            <div className="flex items-center gap-4 text-sm text-gray-500 bg-white px-4 py-2 rounded-lg shadow-sm">
                                ...
                                <span className="flex items-center gap-1">
                                    ...
                                    {submissionCount} / {students.length}{" "}
                                    Submitted
                                </span>
                            </div>
                        </div>
                                                    ...
                                                    >
                                                        <td className="px-6 py-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <p className="font-bold text-gray-900 group-hover:text-indigo-600 transition-colors uppercase tracking-tight">
                                                                        {
                                                                            student.first_name
                                                                        }{" "}
                                                                        {
                                                        ...
                                                        <td className="px-6 py-4">
                                                            {student.submission ? (
                                                                ...
                                                                <Badge
                                                                    variant="outline"
                                                                    className="text-gray-300 font-black text-[9px] uppercase tracking-tighter border-none"
                                                                >
                                                                    Waiting
                                                                </Badge>
                                                            )}
                                                        ...
                                                        <td className="px-6 py-4">
                                                            {student.status ===
                                                            "NOT_SUBMITTED" ? (
                                                                <span className="px-2 py-1 bg-red-50 text-red-500 text-[9px] font-black uppercase rounded border border-red-100">
                                                                    Not
                                                                    Submitted
                                                                </span>
                                                            ) : (
                                                                <span className="px-2 py-1 bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase rounded border border-emerald-100">
                                                                    Complete
                                                                </span>
                                                            )}
                                                        </td>
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div className="h-2 w-16 bg-gray-100 rounded-full overflow-hidden">
                                                                        <div
                                                                            ...
                                                                            style={{
                                                                                width: `${(student.submission.marks_obtained / assignment.max_marks) * 100}%`,
                                                                            }}
                                                                        />
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td className="px-6 py-4 text-right">
                                                            {student.submission ? (
                                                                <Link
                                                                    href={`/ems/tutor/grading/${student.submission.id}`}
                                                                >
                                                                    <Button
                                                                        size="sm"
                                                                ...
                                                                <Button
                                                                    ...
                                                                    variant="ghost"
                                                                    disabled
                                                                    className="h-8 px-4 text-[10px] font-black uppercase opacity-20"
                                                                >
                                                                    Grade
                                                                </Button>
                                                            )}
