...
export default function TutorDashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const response = await api.get(
                `/ems/tutor/dashboard?_t=${Date.now()}`,
            );
    ...
    const quickActions = [
        ...
        },
        {
            ...
            label: "Grading",
            icon: FileCheck,
            href: "/ems/tutor/grading",
            badge: dashboardData.pending_grading_count,
            color: "purple",
        },
        {
            id: "assignments",
    ...
    const statCards = [
        ...
        },
        {
            ...
            icon: CheckSquare,
            color: "indigo",
            href: "/ems/tutor/quizzes",
        },
        {
            label: "Pending Grading",
            value: dashboardData.pending_grading_count,
            icon: FileCheck,
            color: "rose",
            href: "/ems/tutor/grading",
        },
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-indigo-50/30 pb-20">
            ...
            <div className="overflow-y-auto">
                ...
                <div className="relative mx-4 sm:mx-6 mb-6 mt-6 rounded-3xl overflow-hidden shadow-2xl">
                    {/* Gradient Background */}
                    ...
                    <div className="relative p-6 sm:p-8 lg:p-10 text-white">
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            <div className="flex-1">
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[10px] font-bold uppercase tracking-widest mb-4">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10 flex flex-wrap gap-3">
                            ...
                            {dashboardData.pending_grading_count > 0 && (
                                <Link href="/ems/tutor/grading">
                                    <Button
                                        variant="outline"
                                        className="border-white/30 text-white hover:bg-white/10 font-bold rounded-xl backdrop-blur-sm h-11 px-6"
                                    >
                                        <CheckSquare className="h-4 w-4 mr-2" />
                                        Grade Now (
                                        {dashboardData.pending_grading_count})
                                    </Button>
                                </Link>
                            )}
                        </div>
                            ...
                            return (
                                <div key={action.id}>
                                    <Link href={action.href}>
                                        ...
                                        >
                                            <div
                                                className={`w-10 h-10 rounded-xl bg-${action.color}-50 group-hover:bg-${action.color}-600 transition-colors flex items-center justify-center`}
                                            >
                                                <Icon
                                                    className={`h-5 w-5 text-${action.color}-600 group-hover:text-white transition-colors`}
                                                />
                                            </div>
                                            <span className="text-[10px] sm:text-xs font-bold text-gray-600 group-hover:text-purple-700">
                                                {action.label}
                                            </span>
                                            {action.badge &&
                                                action.badge > 0 && (
                ...
                {dashboardData.courses.length > 0 && (
                    <div className="mb-8 overflow-hidden">
                        <div className="flex items-center justify-between px-4 sm:px-6 mb-4">
                            ...
                            <Link
                                href="/ems/tutor/courses"
                                className="text-purple-600 text-xs font-bold flex items-center gap-1 hover:underline"
                            >
                                    ...
                                    >
                                        <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 rounded-3xl overflow-hidden group">
                                            ...
                                            <CardContent className="p-5">
                                                <h4 className="font-bold text-sm mb-1 line-clamp-1 group-hover:text-purple-700 transition-colors">
                                                    {course.course_name}
                                                </h4>
                                                ...
                                                >
                                                    <Button
                                                        size="sm"
                                                        variant="outline"
                                                        className="w-full rounded-xl font-bold text-[11px] border-gray-200 hover:bg-purple-50 hover:border-purple-300"
                                                    >
                                                        Manage Course
                                                    </Button>
                                                </Link>
                                        ...
                                        <div className="mb-6">
                                            <div className="flex items-baseline gap-3 mb-2">
                                                ...
                                                <span className="text-4xl sm:text-5xl font-black tracking-tight">
                                                    {dashboardData.upcoming_classes[0].start_time?.substring(
                                                        0,
                                                        5,
                                                    ) ||
                                                        dashboardData
                                ...
                                <div className="p-6 sm:p-8 lg:w-3/5 flex flex-col justify-between">
                                    <div>
                                        <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-3 leading-tight">
                                            {dashboardData.upcoming_classes[0]
                                                .class_title ||
                                                dashboardData
                                                    .upcoming_classes[0].topic}
                                        </h3>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 mt-4">
                                        {dashboardData.upcoming_classes[0]
                                            ...
                                            <>
                                                ...
                                                <Link
                                                    href={`/ems/tutor/live-classes/${dashboardData.upcoming_classes[0].id}`}
                                                >
                                                    <Button
                                                        variant="outline"
                                                        className="w-full sm:w-auto border-gray-200 hover:bg-gray-50 font-bold rounded-xl h-12"
                                                    >
                                                        Details
                                                    </Button>
                                                </Link>
