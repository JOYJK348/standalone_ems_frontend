                    ...
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:text-base text-gray-600 mt-1">
                                Request approval for a new live class
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    <SelectTrigger
                                                        id="course"
                                                        className="h-12 sm:h-14 rounded-xl border-gray-200 bg-gray-50 font-semibold hover:bg-gray-100 transition-colors"
                                                    >
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    <SelectTrigger
                                                        id="batch"
                                                        className="h-12 sm:h-14 rounded-xl border-gray-200 bg-gray-50 font-semibold hover:bg-gray-100 transition-colors disabled:opacity-50"
                                                    >
                                    ...
                                    <div className="space-y-4 text-gray-300 text-sm leading-relaxed">
                                        <div className="flex gap-3">
                                            ...
                                            <span>
                                                ...
                                                Academic Manager for approval
                                            </span>
                                        </div>
                                        <div className="flex gap-3">
                                            <CheckCircle2 className="h-5 w-5 text-emerald-400 shrink-0 mt-0.5" />
                                            <span>
                                                Students will be notified once
                                                approved
                                            </span>
                                        </div>
                                        <div className="flex gap-3">
                                            <CheckCircle2 className="h-5 w-5 text-emerald-400 shrink-0 mt-0.5" />
                                            <span>
                                                Meeting link becomes visible 15
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-blue-700 leading-relaxed">
                                                Record your sessions and upload
                                                them as course materials for
                                                students who miss the live
                                                class.
                                            </p>
                                        </div>
                                    </div>
