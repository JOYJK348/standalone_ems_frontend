...
export default function CourseManagementPage() {
    ...
    const handleAddLesson = async () => {
        if (!lessonData.lesson_name.trim())
            return toast.error("Lesson name is required");
        if (!selectedModuleId)
            return toast.error("Module selection is required");

        try {
            setIsSubmitting(true);
            const response = await api.post(
                `/ems/courses/modules/${selectedModuleId}/lessons`,
                {
                    ...lessonData,
    ...
    const togglePublish = async (
        ...
        try {
            const response = await api.patch(
                `/ems/courses/content/${type}/${id}/visibility`,
                {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span
                                    className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded ${course.is_published ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-700"}`}
                                >
                                    {course.is_published
                                        ? "Published"
                                        : "Draft"}
                ...
                <div className="max-w-7xl mx-auto mt-4 flex gap-6 overflow-x-auto no-scrollbar">
                    {["curriculum", "students", "assignments"].map((tab) => (
                        <button
                            ...
                            className={`pb-2 text-sm font-bold uppercase tracking-wider transition-colors relative whitespace-nowrap ${
                                activeTab === tab
                                    ? "text-blue-600"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        course.course_modules.length === 0 ? (
                            <Card className="p-12 text-center border-dashed border-2 bg-gray-50/50">
                                ...
                                <p className="text-gray-500 mb-6">
                                    Start by creating your first module and
                                    lessons.
                                </p>
                                <Button
                            ...
                            course.course_modules.map((module, mIdx) => (
                                <Card
                                    key={module.id}
                                    className="border-0 shadow-md overflow-hidden animate-in fade-in slide-in-from-bottom-2"
                                >
                                    <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-b">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Button
                                                variant="ghost"
                                                size="sm"
                                                className={`h-8 gap-2 px-3 text-xs font-bold transition-all ${
                                                    module.visibility ===
                                                    "PUBLIC"
                                    ...
                                    <div className="divide-y">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span
                                                                className={`text-[8px] px-1 rounded uppercase font-black tracking-tighter ${
                                        ...
                                        >
                                            ...
                                            Request Lesson Approval for this
                                            Module
                                        </button>
                                    </div>
                                </Card>
                ...
                {activeTab === "students" && (
                    <div key="students" className="text-center py-20">
                        <Users className="h-16 w-16 text-gray-300 mx-auto mb-4" />
                        <h3 className="text-lg font-bold">
                            Assigned Student Tracking Coming Soon
                        </h3>
                        <p className="text-gray-500">
                            Student enrollment and progress tracking for this
                            course.
                        </p>
                    </div>
                )}
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="p-3 bg-amber-50 rounded-xl border border-amber-100 flex gap-3">
                            ...
                            <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
                                <span className="font-bold block uppercase tracking-tighter mb-0.5">
                                    Approval Workflow:
                                </span>
                                New modules will be sent to the Academic Manager
                                for review. Once approved, you can start adding
                                lessons.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="p-3 bg-blue-50 rounded-xl border border-blue-100 flex gap-3">
                            ...
                            <p className="text-[11px] text-blue-800 leading-relaxed font-medium">
                                ...
                                Lessons are automatically marked as 'Pending
                                Approval'. They will appear in the Academic
                                Manager's dashboard for verification.
                            </p>
                        </div>
                    </div>
                    <DialogFooter>
