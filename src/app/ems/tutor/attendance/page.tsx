...
const AttendanceManagementPage = () => {
    ...
    const handleOpenEntry = async (batchId: number, courseId: number) => {
        try {
            ...
            toast.dismiss();
            toast.error(
                error.response?.data?.message || "Failed to open session",
            );
        }
    };
                                ...
                                <section>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {activeSessions.map((session) => (
                                            <Card
                                                key={session.id}
                                                className="border-0 shadow-xl shadow-emerald-500/10 rounded-[2rem] bg-white overflow-hidden border-l-4 border-emerald-500"
                                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {filteredBatches.length === 0 ? (
                                        ...
                                        filteredBatches.map((batch) => (
                                            <Card
                                                key={batch.id}
                                                className="border-0 shadow-lg hover:shadow-xl transition-all rounded-[2rem] bg-white group overflow-hidden border-b-4 border-blue-500/10 hover:border-blue-500"
                                            >
                                                <CardContent className="p-6">
                                                    <div className="flex items-start justify-between mb-4">
                                                    ...
                                                    <h3 className="text-lg font-black text-gray-900 uppercase tracking-tight mb-1 group-hover:text-blue-600 transition-colors">
                                                        {batch.batch_name}
                                                    </h3>
                                    ...
                                    <div className="space-y-4 text-gray-400 font-medium text-sm leading-relaxed">
                                        <div className="flex gap-4">
                                            ...
                                            <p>
                                                ...
                                                when a live class or offline lab
                                                session begins.
                                            </p>
                                        </div>
                                        <div className="flex gap-4">
                                            ...
                                            <p>
                                                ...
                                                dashboard to check-in using the
                                                session code or QR.
                                            </p>
                                        </div>
                                        <div className="flex gap-4">
                            ...
                            <div className="bg-amber-50 p-8 rounded-[2rem] border border-amber-100 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-amber-700/80 font-medium leading-relaxed">
                                        All finalized attendance sessions are
                                        automatically sent to the Academic
                                        Manager for verification before marks
