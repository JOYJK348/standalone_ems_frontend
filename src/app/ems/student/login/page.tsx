...
export default function StudentLoginPage() {
    ...
    const handleLogin = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            const primaryRole = roles.find((r: any) => r.name === "STUDENT") ||
                roles[0] || { name: "GUEST", level: 0 };
            ...
            if (primaryRole.company_id) {
                Cookie.set(
                    "x-company-id",
                    primaryRole.company_id.toString(),
                    cookieOptions,
                );
            }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] via-white to-[#f1f5f9] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-72 h-72 bg-blue-500/5 rounded-full blur-[80px]" />
                <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-primary/5 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="w-full max-w-5xl relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {/* Login Section */}
                    <div className="premium-glass rounded-3xl p-8 border border-white/50 shadow-2xl backdrop-blur-xl">
                        ...
                        <div className="p-6 rounded-3xl bg-primary/5 border border-primary/10 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-primary/60">
                                    Contact your foundation admin or tutor.
                                </p>
                            </div>
                        </div>
                    </div>
