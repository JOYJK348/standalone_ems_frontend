...
export default function StudentCourseDetailsPage() {
    ...
    const fetchCourseDetails = async () => {
        try {
            ...
            const response = await api.get(
                `/ems/courses/${params.id}?include_active_session=true`,
            );
            if (response.data.success) {
                setCourse(response.data.data);
                if (response.data.data.course_modules?.length > 0) {
                    setExpandedModules([
                        response.data.data.course_modules[0].id,
                    ]);
                }
            }
        } catch (error: any) {
    ...
    const progress =
        totalLessons > 0
            ...
            : 0;
    const courseAllocation = allocations.find(
        (a) => a.course_id === parseInt(params.id as string),
    );
        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="max-w-4xl mx-auto px-4 py-6">
                ...
                {courseAllocation && (
                    <div className="mb-6">
                        <Link
                            href={`/ems/student/practice-lab?courseId=${course.id}`}
                        >
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white/80 text-xs font-medium italic">
                                                Simulate real GST/TDS scenarios
                                                for this course
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <Card className="border-2 border-dashed border-gray-200">
                            <CardContent className="p-12 text-center">
                                ...
                                <p className="text-sm text-gray-400">
                                    Check back later when your tutor releases
                                    the curriculum.
                                </p>
                            </CardContent>
                        </Card>
                                ...
                                (module, moduleIndex) => (
                                    ...
                                    >
                                        ...
                                        {module.course_materials &&
                                            module.course_materials.length >
                                                0 &&
                                            expandedModules.includes(
                                                module.id,
                                            ) && (
                                                <div className="px-4 pb-3 bg-purple-50/30 border-t border-gray-100">
                                                    <div className="text-[10px] font-bold text-purple-600 uppercase tracking-wider mb-2 mt-3">
                                                        Module Resources
                                                    </div>
                                                    <div className="flex flex-wrap gap-2">
                                                        {module.course_materials.map(
                                                            (mat) => (
                                                                <button
                                                                    key={mat.id}
                                                                    onClick={() =>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-600">
                                    Finish all lessons and assignments to unlock
                                    your achievement.
                                </p>
                            </div>
                        </div>
