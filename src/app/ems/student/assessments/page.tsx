...
export default function AssessmentsPage() {
    ...
    const filteredAssessments = assessments.filter((a) => {
        const matchesSearch = a.quiz_title
            .toLowerCase()
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                        {(
                            ["all", "active", "completed", "upcoming"] as const
                        ).map((f) => (
                            <Button
                                key={f}
                        ...
                        <Card className="border-0 shadow-lg p-12 text-center">
                            ...
                            <p className="text-gray-600">
                                {searchQuery
                                    ...
                                    : "You have no assessments scheduled yet."}
                            </p>
                        </Card>
                    ) : (
                                                    ...
                                                    {assessment.best_score !==
                                                        ...
                                                        <div className="flex items-center gap-2 text-green-600 font-semibold">
                                                            ...
                                                            {assessment.is_passed && (
                                                                <span className="ml-2 text-xs bg-green-100 px-2 py-0.5 rounded text-green-700">
                                                                    PASSED
                                                                </span>
                                                            )}
                                                        </div>
                                            ...
                                            <div className="flex flex-row md:flex-col items-center md:items-end gap-3">
                                                ...
                                                >
                                                    {assessment.status
                                                        .charAt(0)
                                                        .toUpperCase() +
                                                        assessment.status.slice(
                                                            1,
                                                        )}
                                                </span>
                                                <Link
                                                    href={`/ems/student/assessments/${assessment.id}`}
                                                >
                                                    <Button
                                                        size="sm"
                                                        disabled={
