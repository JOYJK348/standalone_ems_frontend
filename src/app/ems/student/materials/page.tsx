...
export default function StudentMaterialsPage() {
    ...
    const filteredMaterials = (materials || []).filter((m) => {
        ...
        if (selectedTab === "HANDBOOK")
            return m.handbook_type === "STUDENT_HANDBOOK";
        if (selectedTab === "RESOURCE")
            return m.handbook_type === "GENERAL_RESOURCE" || !m.handbook_type;
    ...
    const materialsByCourse = filteredMaterials.reduce(
        (acc, material) => {
        ...
        {} as Record<
            number,
            { course: Material["course"]; materials: Material[] }
        >,
    );
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                {loading ? (
                    ...
                    <div className="space-y-10">
                        {Object.values(materialsByCourse).map(
            ...
            {selectedMaterial && (
                <div className="fixed inset-0 bg-white z-[200] flex flex-col">
                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        {selectedMaterial.delivery_method === "CONTENT" &&
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar bg-gray-50 p-0 sm:p-6 lg:p-10">
                            <div className="bg-white min-h-full rounded-none sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                {(() => {
                                    ...
                                    const isContent =
                                        type === "CONTENT" ||
                                        selectedMaterial.delivery_method ===
                                            "CONTENT";
                                    ...
                                    if (isImage && url) {
                                        return (
                                            <div className="flex flex-col items-center justify-center p-8 bg-gray-50 min-h-[500px]">
                                                ...
                                                />
                                                <p className="mt-4 text-[10px] font-black uppercase text-gray-400 tracking-widest">
                                                    {fileName}
                                                </p>
                                            </div>
                                        );
                                            ...
                                            return (
                                                <div className="p-20 text-center flex flex-col items-center justify-center min-h-[60vh]">
                                                    ...
                                                    <p className="text-gray-500 mb-10 max-w-sm mx-auto font-medium">
                                                        Direct preview for
                                                        Office documents (.{ext}
                                                        ) is disabled in local
                                                        development. Once
                                                                ...
                                                                >
                                                                    ...
                                                                    {section.external_link && (
                                                                        <a
                                                                            ...
                                                                            className="flex items-center gap-4 p-5 bg-indigo-50 text-indigo-700 rounded-2xl font-bold hover:bg-indigo-100 transition-all border border-indigo-100"
                                                                        >
                                    ...
                                    return (
                                        <div className="p-20 text-center flex flex-col items-center justify-center min-h-[60vh]">
                                            ...
                                            <p className="text-gray-500 mb-10 max-w-sm mx-auto font-medium text-lg">
                                                {ext
                                                    ? `We can't generate a live preview for .${ext.toUpperCase()} files yet.`
                                                    : "We can't generate a live preview for this asset."}
                                            </p>
                                            <Button
                                                onClick={() =>
                                                    url &&
