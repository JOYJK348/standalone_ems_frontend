...
export default function StudentDashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const response = await api.get(
                `/ems/students/dashboard?_t=${Date.now()}`,
            );
    ...
    const handleAttendanceClick = () => {
        if (
            dashboardData.active_attendance_sessions &&
    ...
    const pendingAttendance = dashboardData.active_attendance_sessions.filter(
    ...
    const quickActions = [
        {
            ...
            badge: dashboardData.pending_assignments.length,
        },
        {
            id: "materials",
            label: "Materials",
            icon: BookOpen,
            href: "/ems/student/materials",
        },
        {
            id: "doubts",
            label: "Doubts",
            icon: MessageSquare,
            href: "/ems/student/doubts",
        },
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="overflow-y-auto">
                ...
                {primaryCourse && (
                    <div className="relative mx-4 sm:mx-6 mb-6 mt-6 rounded-2xl overflow-hidden shadow-xl">
                        ...
                        <div className="relative p-6 sm:p-8 text-white">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-bold mb-2">
                                    {primaryCourse.course.course_name}
                                </h2>
                                    ...
                                    <div className="relative w-16 h-16 sm:w-20 sm:h-20">
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <span className="text-sm sm:text-base font-bold">
                                                {Math.round(
                                                    primaryCourse.completion_percentage ||
                                                        0,
                                                )}
                                                %
                                            </span>
                                ...
                                {/* Resume CTA */}
                                <Link
                                    href={`/ems/student/courses/${primaryCourse.course.id}`}
                                >
                                    <Button
                                        size="lg"
                                    ...
                                    >
                                        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            <div className="p-4">
                                                ...
                                                {/* Resume CTA */}
                                                <Link
                                                    href={`/ems/student/courses/${enrollment.course.id}`}
                                                >
                                                    <Button
                                                        size="sm"
                                                        className="w-full"
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-green-50 text-xs font-medium">
                                        Click anywhere to mark your presence now
                                    </p>
                                </div>
                            </div>
                ...
                {dashboardData.upcoming_live_classes.length > 0 && (
                    <div className="mb-8 px-4 sm:px-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {dashboardData.upcoming_live_classes.length > 1 && (
                                <span className="text-[10px] font-black bg-blue-100 text-blue-700 px-2 py-1 rounded-lg">
                                    {dashboardData.upcoming_live_classes.length}{" "}
                                    SCHEDULED
                                </span>
                            )}
                        </div>
                        ...
                        <div className="space-y-4">
                            {dashboardData.upcoming_live_classes
                                .slice(0, 3)
                                .map((liveClass, idx) => (
                                    <div key={liveClass.id}>
                                        {liveClass.meeting_link ||
                                        liveClass.external_link ? (
                                            <Link
                                                href={
                                                    liveClass.meeting_link ||
                                                    liveClass.external_link
                                            ...
                                            <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-700 to-purple-800 text-white overflow-hidden relative opacity-75">
                                                ...
                                                <CardContent className="p-5">
                                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                        ...
                                                        <Button
                                                            disabled
                                                            className="w-full sm:w-auto bg-white/10 text-white/40 border-0"
                                                        >
                                                            Link Pending
                                                        </Button>
                                                    </div>
