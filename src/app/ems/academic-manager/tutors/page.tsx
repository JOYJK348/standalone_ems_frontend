...
export default function TutorsPage() {
    ...
    const handleAddTutor = async (e: React.FormEvent) => {
        ...
        try {
            const response = await api.post("/ems/tutors", {
                employee_id: parseInt(selectedCandidate),
            });
            if (response.data.success) {
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">
                                Manage teaching staff and course assignments
                            </p>
                        </div>
                        <Button
                            ...
                            {filteredTutors.length > 0 ? (
                                    ...
                                    >
                                        <CardContent className="p-6">
                                            ...
                                            <div className="flex gap-2">
                                                <Link
                                                    href={`/ems/academic-manager/tutors/${tutor.id}/assign-courses`}
                                                    className="flex-1"
                                                >
                                                    <Button
                                                        size="sm"
                                                        className="w-full bg-white border border-purple-200 text-purple-600 hover:bg-purple-50 hover:border-purple-300 font-bold shadow-sm"
                                                    >
                                ...
                                <div className="col-span-full py-12 text-center">
                                    ...
                                    <p className="text-gray-500">
                                        Add staff via the button above.
                                    </p>
                                </div>
                            )}
                        </div>
                            ...
                            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-purple-100 text-xs mt-1">
                                        Select an existing employee to promote
                                    </p>
                                </div>
                                <Button
                                    variant="ghost"
                            ...
                            <form onSubmit={handleAddTutor} className="p-6">
                                <div className="space-y-4 mb-6">
                                    <div>
                                        ...
                                        <p className="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                            ...
                                            Only showing employees with linked
                                            user accounts
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <Button
                                        ...
                                        className="flex-1 bg-purple-600 hover:bg-purple-700 text-white font-bold shadow-lg shadow-purple-200"
                                    >
                                        Confirm Assignment
                                    </Button>
                                </div>
