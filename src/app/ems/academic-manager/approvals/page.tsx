...
const ApprovalsPage = () => {
    ...
    const handleAction = async (
        ...
        try {
            ...
            fetchPendingItems();
            if (action === "REJECT")
                setRejectModal({ ...rejectModal, open: false, reason: "" });
        } catch (error) {
    ...
    const getAllItems = () => {
        const items = [
            ...pendingData.courses.map((i: any) => ({
                ...i,
                type: "course",
                displayType: "Course",
                icon: BookOpen,
            })),
            ...pendingData.lessons.map((i: any) => ({
                ...i,
                type: "lesson",
                displayType: "Lesson",
                icon: Layout,
            })),
            ...pendingData.materials.map((i: any) => ({
                ...i,
                type: "material",
                displayType: "Material",
                icon: FileText,
            })),
            ...pendingData.assignments.map((i: any) => ({
                ...i,
                type: "assignment",
                displayType: "Assignment",
                icon: ClipboardList,
            })),
            ...pendingData.quizzes.map((i: any) => ({
                ...i,
                type: "quiz",
                displayType: "Quiz",
                icon: GraduationCap,
            })),
            ...pendingData.batches.map((i: any) => ({
                ...i,
                type: "batch",
                displayType: "Batch",
                icon: Users,
            })),
            ...pendingData.live_classes.map((i: any) => ({
                ...i,
                type: "live_class",
                displayType: "Live Class",
                icon: Video,
            })),
            ...pendingData.attendance_sessions.map((i: any) => ({
                ...i,
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 pb-24">
            <AcademicManagerLayout>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Review and approve content submitted by
                                    tutors
                                </p>
                            </div>

                            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-2xl flex items-center gap-3 shadow-lg shadow-purple-500/30">
                            ...
                            {loading ? (
                                ...
                                <div className="p-20 sm:p-32 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-gray-500 mt-2 font-medium max-w-xs">
                                        There are no pending items that require
                                        your review at this moment.
                                    </p>
                                </div>
                            ) : (
                                    ...
                                    <Table>
                                        <TableHeader className="bg-gradient-to-r from-purple-50 to-blue-50">
                                            <TableRow className="border-b border-gray-100 hover:bg-transparent">
                                                <TableHead className="font-black text-[10px] uppercase tracking-widest text-gray-500 py-6 px-6">
                                                    Content Info
                                                </TableHead>
                                                <TableHead className="font-black text-[10px] uppercase tracking-widest text-gray-500">
                                                    Context
                                                </TableHead>
                                                <TableHead className="font-black text-[10px] uppercase tracking-widest text-gray-500">
                                                    Submission Date
                                                </TableHead>
                                                <TableHead className="font-black text-[10px] uppercase tracking-widest text-gray-500 text-right pr-6">
                                                    Actions
                                                </TableHead>
                                            </TableRow>
                                        </TableHeader>
                                                    ...
                                                    <TableCell className="py-5 px-6">
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                <Badge
                                                                    variant="outline"
                                                                    className="mb-1.5 rounded-lg bg-white font-bold text-[9px] uppercase tracking-wide border-gray-200"
                                                                >
                                                                    {
                                                                        item.displayType
                                                                    }
                ...
                <Dialog
                    ...
                    onOpenChange={(open) =>
                        !open && setRejectModal({ ...rejectModal, open: false })
                    }
                >
                    <DialogContent className="sm:max-w-md rounded-3xl border-0 shadow-2xl">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-gray-500 font-medium mt-2">
                                Please provide a brief explanation for rejecting
                                this content. This feedback will be sent to the
                                tutor.
                            </DialogDescription>
                        </DialogHeader>
