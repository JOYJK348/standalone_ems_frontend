...
export default function FeeStructurePage() {
    ...
    useEffect(() => {
        api.get("/ems/courses?limit=200")
            .then((res) => {
                if (res.data.success)
                    setCourses(
                        res.data.data?.courses || res.data.data?.data || [],
                    );
            })
            .catch(() => {});
    }, []);
    ...
    const removeInstallment = (index: number) => {
        ...
        const updated = installments
            .filter((_, i) => i !== index)
            .map((inst, i) => ({ ...inst, installment_no: i + 1 }));
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Create fee plans with installment tracking
                        </p>
                    </div>
                    ...
                    <Card className="border-0 shadow-sm mb-6">
                        <CardContent className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <Input
                                    type="text"
                                    placeholder="e.g. NEET Course Fee"
                                    value={feeName}
                    ...
                    <Card className="border-0 shadow-sm mb-6">
                        <CardContent className="p-6">
                            ...
                            <div
                                className={`mt-4 p-3 rounded-lg flex items-center gap-2 ${isBalanced ? "bg-green-50" : "bg-red-50"}`}
                            >
                                {isBalanced ? (
                                ...
                                <span
                                    className={`text-sm font-medium ${isBalanced ? "text-green-700" : "text-red-700"}`}
                                >
                    ...
                    <p className="text-xs text-gray-400 mt-2 text-center">
                        This will create the fee structure and all installments
                        at once
                    </p>
                </div>
            </FinanceManagerLayout>
